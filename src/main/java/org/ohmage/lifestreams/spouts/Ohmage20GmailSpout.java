...
public class Ohmage20GmailSpout extends Ohmage20OAuthDataSpout<EmailMsg> {
    ...
    public Ohmage20GmailSpout(Ohmage20User requester, IProvider resourceProvider, Ohmage20Stream accessTokenStream,
                              DateTime since) {
        super(requester, accessTokenStream, providerNamePattern, scopePattern, since, 1, TimeUnit.HOURS);
    ...
    @Override
    protected Iterator<StreamRecord<EmailMsg>> getIteratorFor(IUser user,
                                                              DateTime since) {
        try {
            ...
            logger.error("Error retreiving sent mails for " + user.getId(), e);
        }
        return null;
