...
public class MiscTests {
	...
	public void testJoda() {
		assertEquals(1,
				new Duration(Seconds.seconds(60).toStandardDuration())
						.getStandardMinutes());
	}
	...
	public void testHmm() {
		...
		MobilityState[] data = new MobilityState[] { MobilityState.STILL,
				MobilityState.STILL, MobilityState.STILL, MobilityState.STILL,
				MobilityState.STILL, MobilityState.STILL, MobilityState.DRIVE,
				MobilityState.DRIVE, MobilityState.DRIVE, MobilityState.DRIVE,
				MobilityState.DRIVE, MobilityState.STILL, MobilityState.STILL,
				MobilityState.STILL, MobilityState.DRIVE, MobilityState.DRIVE,
				MobilityState.DRIVE, MobilityState.STILL, MobilityState.STILL,
				MobilityState.STILL, MobilityState.STILL, MobilityState.DRIVE,
				MobilityState.STILL, MobilityState.STILL, MobilityState.STILL,
				MobilityState.STILL,

				MobilityState.RUN, MobilityState.WALK, MobilityState.RUN,
				MobilityState.STILL };
